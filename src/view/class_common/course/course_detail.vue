    ...
    <div style="width:100%;height:100%;position:relative">
      <Row style="width:100%;height:100%;position:absolute;overflow:hidden">
        ...
        <Card shadow v-if="course.course_type === 1">
          <ChapterClass :type="course.course_type" :teacher_course_id="teacher_course_id" :course_id="course.id"
            :editable="false"></ChapterClass>
        </Card>
        <!-- 全景课程 -->
        <Row v-else>
          <PanoChapter :type="course.course_type" :teacher_course_id="teacher_course_id" :course_id="course.id"
            :editable="false"></PanoChapter>
        </Row>
        </Col>
