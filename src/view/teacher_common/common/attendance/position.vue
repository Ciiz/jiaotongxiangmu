<template>
  <div class="map-container">
    <div>
      ...
      考勤有效范围: <InputNumber v-model="radius"  style="width: 80px" placeholder="考勤有效范围"  @on-change="handleRangeChange"/>米
    ...
    <baidu-map :center="{lng:lng,lat:lat}"  @ready="mapReady" :zoom="zoom" @dblclick="dbclick" class="bm-view" ak="2NSf0hRUjyORiH1CDMWPrrlUNE53k8mi">
        <bm-navigation anchor="BMAP_ANCHOR_TOP_RIGHT" :showZoomInfo="true"></bm-navigation>
        <bm-geolocation anchor="BMAP_ANCHOR_BOTTOM_RIGHT" :showAddressBar="true" :autoLocation="true"></bm-geolocation>
        <bm-marker @dragend="dragend" :position="{lng:lng,lat:lat}" :dragging="true" :clicking="true" :icon="{url: locationIcon, size: {width: 40, height: 40}}"></bm-marker>
