<template>
  <div class="modal-content">
    ...
    <Input type="textarea" class="homework-evaluate-textarea" placeholder="对学生的评价：" :rows="4"
    ...
    getInfo () {
      ...
      this.axios.request({
        ...
        if (res.code === 200) {
          ...
          // console.log(Object.prototype.toString.call(this.evaluation));
          // console.log(this.evaluation instanceof Array);
