...
<script>
import { get_exam_release_list } from '@/api/data'
      ...
      columns: [
        ...
        },
        {
          ...
          render: (h, params) => {
            ...
            return (
              <div>
                <Button size="small" type="primary" onClick={() => { this.open('student_exam_list', row.exam_release_id, `${row.class_name}-测试: ${row.exam_name}`) }}>批改</Button>
              </div>
            )
          }
        }
