<template>
  <div>
    <Row>
      ...
      <video :src="file_url" v-if="['mp4','ogg', 'avi', 'rmvb'].indexOf(content_type)!==-1" controls autoplay
      ...
      <div v-else-if="['ppt','pptx','xlsx','xls','doc','docx'].indexOf(content_type)!==-1"
        ...
        <iframe :src='`https://view.officeapps.live.com/op/view.aspx?src=${file_url}`' width='100%' height='100%'
