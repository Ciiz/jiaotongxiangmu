...
<div style="height:100%;background:#f2f2f2;padding:20px 20px 0 20px;overflow-y:scroll">
  <div style="width:100%;height:100%;position:relative">
    <div style="width:100%;height:100%" class="homework-exam-modal">
      <Homework @closeModal='closeModal' :submit_status="submit_status" :student_homework_id="student_homework_id" v-if="target === 'homework'" @success="handleSuccess"></Homework>
      <Exam @closeModal='closeModal' :student_exam_id="student_exam_id" :sty="sty" v-if="target === 'exam'" @success="handleSuccess"></Exam>
    </div>
    <div style="height:100%;display:flex;flex-direction:column">
      <div class="correct-iscorrect">
        ...
        <span style="background:#ffffff" v-if="submit_status===1" @click="submit_status=0;getHomework();getExam()">未作答</span>
      ...
      <div style="width:100%;height:100%;position:relative">
        <div class="correct-list">
          ...
          <div v-show="submit_status===0" style="height:100%">
            <div v-if="Object.keys(homeworkList).length===0&&Object.keys(examlist).length===0" style="padding:10px;font-size:16px">暂无内容</div>
            <div v-for="(item,index) in homeworkList" :key="'homework'+index" style="width:300px;margin:10px 0;float:left">
          ...
          <div v-show="submit_status===1" style="height:100%;display:flex;flex-direction:column">
            ...
            <Tabs size="small" @on-click="getData" class="correct-tab" style="flex:1" v-model="tabS" value="task" v-if="submit_status===1">
